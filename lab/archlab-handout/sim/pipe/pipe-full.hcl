...
bool need_valC =
	f_icode in { IIADDQ, IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL };
...
word d_srcB = [
	D_icode in { IIADDQ, IOPQ, IRMMOVQ, IMRMOVQ  } : D_rB;
...
word d_dstE = [
	D_icode in { IIADDQ, IRRMOVQ, IIRMOVQ, IOPQ} : D_rB;
	D_icode in { IPUSHQ, IPOPQ, ICALL, IRET } : RRSP;
...
word aluA = [
	...
	E_icode in { IIADDQ, IIRMOVQ, IRMMOVQ, IMRMOVQ } : E_valC;
...
word aluB = [
	E_icode in { IIADDQ, IRMMOVQ, IMRMOVQ, IOPQ, ICALL, 
